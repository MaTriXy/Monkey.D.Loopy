...
The built-in `pi` harness ([#5](https://github.com/MaTriXy/Monkey.D.Loopy/issues/5)) can ship as
an independent `0.2.x` feature after the release baseline. It is useful but is not a dependency
