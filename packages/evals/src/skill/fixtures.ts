...
export const FIXTURES: SkillFixture[] = [
  ...
  { id: "bug-sweep", nl: "Keep hunting for issues until two passes in a row find nothing new.", expectedPatterns: ["loop-until-dry"], minTier: "state-predicate", minScore: 70, golden: bp("loop-until-dry") },
